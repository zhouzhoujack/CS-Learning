...
class Window(QDialog):
    def __init__(self):
        ...
        self.trayIcon.messageClicked.connect(self.messageClicked)       # 托盘消息点击事件绑定
        self.trayIcon.activated.connect(self.iconActivated)             # 托盘激活事件绑定
    ...
    def createMessageGroupBox(self):
        ...
        print(QSystemTrayIcon.Information)
    ...
    def createTrayIcon(self):
        ...
        self.trayIconMenu.addSeparator()        # 设置分割线
